...
var PhotoSlideShowEditorVars = {
  ...
  // Used to load a photo slide show zip file without adding to a gallery when set false
  loadToGallery:true
...
//  into a gallery for editing. There must be a
// *********************************************************************************************************
...
//
// Called when the image file data has been loaded, will add to the end of the gallery depending on the state of the
// loadToGallery flag
//

function EditSlideShowAddImageToEndOfGallery(evt)
{
  if (PhotoSlideShowEditorVars.loadToGallery)
  {
