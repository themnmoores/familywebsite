...
function StartGoogleDocsHTMLZipConvert() {
    ...
    reader.onloadend = ReadOfArchiveFileCompletedJsZipTry2;
...
function ReadOfArchiveFileCompletedJsZipTry2(evt)
{
    ...
    .then(function success(zip) {
      ...
      .then(function success(content){
        ...
        // We get the keywords and description text from the document, if any. Used to conditionally figure out if we are converting the pictures page
        // Yes, I know a bit messy but it is the quickest way to do it
        var keywords = '';
        ...
        if (description.indexOf('Picture albums on themnmoores website') == -1)
        {
          ...
          content = content.replace('<p class=', '\n\n<script>setBodyBackgroundFormatting();</script>\n<div id="headerTopBar"></div>\n<script>commonPageHeaderBarNew2("","");</script>\n<script>commonNavivationButtonsNew2("","2");</script>\n\n<div style="text-align:center;margin-top:3vw" >\n\n<div style="width:612pt;margin-left: auto;margin-right: auto;">\n\n<p class=');
        }
        ...
        // This section removes the extra stuff google puts in for html links that causes a redirect warning
